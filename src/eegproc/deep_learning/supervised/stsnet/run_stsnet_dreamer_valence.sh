#!/bin/bash
#SBATCH --job-name=stsnet_dreamer_valence
#SBATCH --output=stsnet_dreamer_valence_%j.out
#SBATCH --error=stsnet_dreamer_valence_%j.err
...
python -u train_eval.py \
    ...
    --results_dir outputs/dreamer_valence