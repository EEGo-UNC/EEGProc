#!/bin/bash
#SBATCH --job-name=joint_v2_dreamer_valence_gcn
#SBATCH --output=joint_v2_dreamer_valence_gcn_%j.out
#SBATCH --error=joint_v2_dreamer_valence_gcn_%j.err
...
python -m src.eegproc.deep_learning.joint_architectures.joint_v2_autoencoder_vc_train \
    ...
    --n-channels 14 \
    --n-bands 4 \
    --out-dir runs/joint_autoencoder_vc_v2/GCN_supcon \
