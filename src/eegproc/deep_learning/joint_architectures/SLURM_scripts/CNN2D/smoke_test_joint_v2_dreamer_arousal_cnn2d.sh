#!/bin/bash
#SBATCH --job-name=smoke_joint_v2_dreamer_arousal_cnn2d
#SBATCH --output=smoke_joint_v2_dreamer_arousal_cnn2d_%j.out
#SBATCH --error=smoke_joint_v2_dreamer_arousal_cnn2d_%j.err
