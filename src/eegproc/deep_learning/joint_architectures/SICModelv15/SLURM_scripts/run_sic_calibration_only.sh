...
srun python -u -m \
  eegproc.deep_learning.joint_architectures.SICModelv15.sic_calibration_only_train \
  --models-config "src/eegproc/deep_learning/joint_architectures/SICModelv15/calibration_hps/sic_calibration_model.json" \
  --calibration-hyperparameters-file "src/eegproc/deep_learning/joint_architectures/SICModelv15/calibration_hps/sic_calibration_full_grid.json" \
