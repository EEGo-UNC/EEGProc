#!/bin/bash
#SBATCH --job-name=joint_v2_amigos_valence
#SBATCH --output=joint_v2_amigos_valence_%j.out
#SBATCH --error=joint_v2_amigos_valence_%j.err
...
python -u src/eegproc/deep_learning/joint_architectures/joint_v2_autoencoder_vc_train.py \
    ...
    --out-dir src/eegproc/deep_learning/joint_architectures/runs/amigos_valence \
    --run-name amigos_valence