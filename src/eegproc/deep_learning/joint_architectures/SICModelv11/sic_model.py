...
loss, or decoder. Subject invariance can be imposed directly on the recurrent
trial representation (or per-window representation in window mode) with
ordinary gradient reversal.
